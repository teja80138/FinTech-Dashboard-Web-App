    ...
    <div className="min-h-screen flex items-center justify-center px-4 relative overflow-hidden"
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-slate-400 mt-1 text-sm">Sign in to your FinTech account</p>
        </div>
        ...
        <div className="rounded-2xl p-8" style={{ background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.08)', backdropFilter: 'blur(20px)' }}>
          ...
          {error && (
            <div className="mb-5 p-3 rounded-xl flex items-center gap-2 text-sm"
              ...
              <button onClick={clearError} className="ml-auto text-rose-400 hover:text-rose-300 transition-colors text-xs">✕</button>
            </div>
          )}
        ...
        <div className="mt-5 text-center">
          <p className="text-xs text-slate-600">Demo: <span className="text-slate-500">demo@example.com / password123</span></p>
        </div>
      </div>
    </div>
  );
